...
function displayPics() {
  ...
  // because when we use var in this case inside the a scope inside a scope function it will be defined for its scope and the parent of the scope which is the function but when we use let it will only be declared inside its scope and the console is inside the function scope.
  console.log(viewed);
